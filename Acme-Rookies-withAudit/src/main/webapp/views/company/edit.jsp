...
<form:form action="company/edit.do" modelAttribute="companyForm" id="form">

	<acme:hiddenInputs attributes="id" />

	<acme:textbox code="company.userAccount.username" path="username" />

	
	<acme:password code="company.userAccount.newPassword"
		path="newPassword" />
	<acme:password code="company.userAccount.confirmPassword"
	...
	<acme:textbox code="company.picture" path="picture" />
	<acme:textbox code="company.phoneNumber" path="phoneNumber" />
	<acme:textbox code="company.address" path="address" />
	<acme:textbox code="company.vat" path="vat" vatPlaceholder="true" />
	<acme:textbox code="company.commercialName" path="commercialName" />
	
	<acme:textbox code="company.creditCard.number" path="number" />
	<acme:textbox code="company.creditCard.cvv" path="cvv" typeNumber="true" />
	<acme:textbox code="company.creditCard.holderName" path="holderName" />
	<acme:textbox code="company.creditCard.make" path="make" />
	<acme:textbox code="company.creditCard.expirationMonth" path="expirationMonth" typeNumber="true"/>
	<acme:textbox code="company.creditCard.expirationYear" path="expirationYear" typeNumber="true"/>
	...
	<jstl:if test="${companyForm.id == 0}">
		<acme:editButtons entity="company" role="company"
