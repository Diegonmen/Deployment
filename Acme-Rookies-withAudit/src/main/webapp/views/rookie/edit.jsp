...
<form:form action="rookie/edit.do" modelAttribute="rookieForm" id="form">

	<acme:hiddenInputs attributes="id" />

	<acme:textbox code="rookie.userAccount.username" path="username" />

	
	<acme:password code="rookie.userAccount.newPassword"
		path="newPassword" />
	<acme:password code="rookie.userAccount.confirmPassword"
	...
	<acme:textbox code="rookie.picture" path="picture" />
	<acme:textbox code="rookie.phoneNumber" path="phoneNumber" />
	<acme:textbox code="rookie.address" path="address" />
	<acme:textbox code="rookie.vat" path="vat" vatPlaceholder="true"/>
	
	<acme:textbox code="rookie.creditCard.number" path="number" />
	<acme:textbox code="rookie.creditCard.cvv" path="cvv" typeNumber="true" />
	<acme:textbox code="rookie.creditCard.holderName" path="holderName" />
	<acme:textbox code="rookie.creditCard.make" path="make" />
	<acme:textbox code="rookie.creditCard.expirationMonth" path="expirationMonth" typeNumber="true"/>
	<acme:textbox code="rookie.creditCard.expirationYear" path="expirationYear" typeNumber="true"/>

	<jstl:if test="${rookieForm.id == 0}">
	...
	<jstl:if test="${rookieForm.id == 0}">
		<acme:editButtons entity="rookie" role="rookie"
	...
	<div id="myModal" class="modal">
		...
		<div class="modal-content">
			...
			<jstl:if test="${locale == 'es' }">
				...
				<br />
				<span style="text-transform: capitalize;"> Acme-Madrugá Inc.</span> se encuentra en: <br />
				<address>
