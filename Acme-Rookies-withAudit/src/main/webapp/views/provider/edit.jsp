...
<form:form action="provider/edit.do" modelAttribute="providerForm" id="form">

	<acme:hiddenInputs attributes="id" />

	<acme:textbox code="provider.userAccount.username" path="username" />

	
	<acme:password code="provider.userAccount.newPassword"
		path="newPassword" />
	<acme:password code="provider.userAccount.confirmPassword"
	...
	<acme:textbox code="provider.picture" path="picture" />
	<acme:textbox code="provider.phoneNumber" path="phoneNumber" />
	<acme:textbox code="provider.address" path="address" />
	<acme:textbox code="provider.vat" path="vat" vatPlaceholder="true"/>
	<acme:textbox code="provider.make" path="makeProvider" />
	
	<acme:textbox code="provider.creditCard.number" path="number" />
	<acme:textbox code="provider.creditCard.cvv" path="cvv" typeNumber="true" />
	<acme:textbox code="provider.creditCard.holderName" path="holderName" />
	<acme:textbox code="provider.creditCard.make" path="make" />
	<acme:textbox code="provider.creditCard.expirationMonth" path="expirationMonth" typeNumber="true"/>
	<acme:textbox code="provider.creditCard.expirationYear" path="expirationYear" typeNumber="true"/>
	...
	<jstl:if test="${providerForm.id == 0}">
		<acme:editButtons entity="provider" role="provider"
