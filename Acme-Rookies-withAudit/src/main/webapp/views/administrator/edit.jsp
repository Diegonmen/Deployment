...
<form:form action="administrator/edit.do"
	...
	<acme:textbox code="administrator.vat" path="vat" vatPlaceholder="true"/>
	
	
	<acme:textbox code="administrator.creditCard.number" path="number" />
	<acme:textbox code="administrator.creditCard.cvv" path="cvv" typeNumber="true" />
	<acme:textbox code="administrator.creditCard.holderName" path="holderName" />
	<acme:textbox code="administrator.creditCard.make" path="make" />
	<acme:textbox code="administrator.creditCard.expirationMonth" path="expirationMonth" typeNumber="true"/>
	<acme:textbox code="administrator.creditCard.expirationYear" path="expirationYear" typeNumber="true"/>
