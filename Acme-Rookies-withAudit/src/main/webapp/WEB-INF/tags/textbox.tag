...
<%@ attribute name="vatPlaceholder" required="false" %>
...
<div>
	...
	<jstl:if test="${vatPlaceholder == true}">
		<form:input path="${path}" readonly="${readonly}" type="${type}" placeholder="(ES)123456789" />
	</jstl:if>
	<jstl:if test="${(datePlaceholder == false || datePlaceholder == null) && (vatPlaceholder == false || vatPlaceholder == null)}">
